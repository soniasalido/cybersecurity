...
Si seguimos la secuencia HTML de unos de los paquetes en los que observamos el ataque, veremos que en la respuesta se exfiltran datos del servidor donde está alojada la página:
